...
// Cloudflare Worker endpoint (Part C). Deployed via `cd worker && wrangler deploy`.
// Submissions now hit the live worker; while this string was empty the helper
// used to short-circuit to a local-only success path.
export const WAITLIST_ENDPOINT = 'https://catchly-waitlist.catchly-dev.workers.dev/signup';
